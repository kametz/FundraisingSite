...
<body>
  ...
  <main class="row browse">
    <div class="search-row">
      <div class="column small-7 medium-8 search">
        <i class="fa fa-search"></i>  &nbsp;
        Search for Projects  
      </div><!-- /search -->  
      <button class="column small-2 medium-1 search-submit" name="Submit">
        <i class="fa fa-chevron-circle-right fa-2x"></i>
      </button>
      <div class="column small-3 category">
        <ul>
          <li><a href="#">Select<br>Category <i class="fa fa-chevron-down"></i></a>
            <ul>
    ...
    <div class="row browse-project" data-equalizer>

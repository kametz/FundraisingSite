...
<head>
  <meta charset="UTF-8">
  <title>Gifti: Help Puppies Learn To Read</title>
...
<body>
  ...
  <main class="detail">
    <div class="row">
      <div class="column small-12 medium-6 title-block">
      ...
      <div class="column small-4 medium-2 project-metrics">
        $4500<br> 
        goal
      </div>
      <div class="column small-4 medium-2 project-metrics">
    ...
    <div class="row">
      <div class="flexslider column small-12 medium-6">
        <ul class="slides">
          <li data-thumb="../images/detail/thumbs/puppy3.jpg">
            <img src="../images/detail/puppy3.jpg" />
          </li>
          <li data-thumb="../images/detail/thumbs/puppy1.jpg">
            <img src="../images/detail/puppy1.jpg" />
          </li>
          <li data-thumb="../images/detail/thumbs/puppy2.jpg">
            <img src="../images/detail/puppy2.jpg" />
          </li>
        </ul>
      </div> <!-- /slider -->

      <div class="column small-12 medium-6 project-description">
 ...
 <!-- JQuery -->
  ...
  <script src="../js/thumbslider.js"></script>
